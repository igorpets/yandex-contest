...
public class YandexContestDownloadingResourcesInTheDataCenterByArrayList {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("input.txt"))) {
            ...
            while (curr_link++ < links_count) {
                ...
                if (index1 < 0 && index2 < 0) {
                    ...
                    ArrayList<Integer> cluster1 = clusters.get(index1);
                    ArrayList<Integer> cluster2 = clusters.get(index2);
            ...
            while (curr_file_index++ < files_count) {
                ...
                ArrayList<Integer> target_cluster = null;
